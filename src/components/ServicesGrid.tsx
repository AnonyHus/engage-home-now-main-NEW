          ...
          {services.map((service, index) => (
            ...
            >
              <CardContent className="p-8 text-center">
                ...
                : (
                  <span className="h-8 w-8 text-[#FF0014] flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <rect x="3" y="5" width="18" height="14" rx="2" stroke="currentColor" strokeWidth="2" fill="none"/>
                      <path d="M7 5v-2h10v2" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                      <path d="M7 19v2h10v-2" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                      <path d="M8 9h8v6H8z" stroke="currentColor" strokeWidth="2" fill="none"/>
