import{c as o,u as c,j as e,L as n,B as d,b as h,F as g}from"./index-BTwGVszu.js";import{C as t,a as r}from"./card-D9UtOVfR.js";import{U as p,C as m}from"./user-BBAyntcq.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const u=o("Clock",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polyline",{points:"12 6 12 12 16 14",key:"68esgv"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const x=o("Tag",[["path",{d:"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z",key:"vktsd0"}],["circle",{cx:"7.5",cy:"7.5",r:".5",fill:"currentColor",key:"kqv944"}]]),v=()=>{const{id:l}=c(),a=[{id:1,title:"The Future of Web Development in 2024",content:`
      ...
      `,author:"Emma Davis",date:"March 10, 2024",category:"Marketing",readTime:"6 min read",image:"bg-gradient-to-br from-[#E50012] to-[#F60013]"}],s=a.find(i=>i.id===parseInt(l||"1"));return s?e.jsxs("div",{className:"min-h-screen bg-white",children:[e.jsx("section",{className:"py-20 bg-white",children:e.jsxs("div",{className:"max-w-4xl mx-auto px-4",children:[e.jsx("div",{className:"mb-8",children:e.jsx(n,{to:"/blog",children:e.jsxs(d,{variant:"ghost",className:"mb-6 text-gray-700 hover:text-[#C30010]",children:[e.jsx(h,{className:"h-4 w-4 mr-2"}),"Back to Blog"]})})}),e.jsxs("div",{className:"text-center mb-8",children:[e.jsxs("div",{className:"inline-block bg-[#C30010]/20 text-[#C30010] px-4 py-2 rounded-full text-sm font-medium mb-4 border border-[#C30010]/30",children:[e.jsx(x,{className:"h-4 w-4 inline mr-2"}),s.category]}),e.jsx("h1",{className:"text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight",children:s.title}),e.jsxs("div",{className:"flex items-center justify-center gap-6 text-gray-700 mb-6",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(p,{className:"h-4 w-4"}),e.jsx("span",{children:s.author})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(m,{className:"h-4 w-4"}),e.jsx("span",{children:s.date})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(u,{className:"h-4 w-4"}),e.jsx("span",{children:s.readTime})]})]})]})]})}),e.jsx("section",{className:"py-16",children:e.jsx("div",{className:"max-w-4xl mx-auto px-4",children:e.jsx(t,{className:"shadow-xl border border-gray-200 bg-white/50",children:e.jsx(r,{className:"p-8",children:e.jsx("div",{className:"prose prose-lg max-w-none",children:e.jsx("div",{dangerouslySetInnerHTML:{__html:s.content}})})})})})}),e.jsx("section",{className:"py-16 bg-white",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4",children:[e.jsx("h2",{className:"text-3xl font-bold text-center text-gray-900 mb-12",children:"Related Articles"}),e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-8",children:a.filter(i=>i.id!==s.id).slice(0,3).map(i=>e.jsx(n,{to:`/blog/${i.id}`,children:e.jsx(t,{className:"overflow-hidden hover:shadow-lg transition-shadow cursor-pointer border border-gray-800 bg-gray-800/50 hover:bg-gray-800/80",children:e.jsxs(r,{className:"p-6",children:[e.jsx("div",{className:`h-32 ${i.image} rounded-lg mb-4 flex items-center justify-center`,children:e.jsx("div",{className:"text-center text-gray-900",children:e.jsx("div",{className:"text-sm font-medium opacity-90",children:i.category})})}),e.jsx("h3",{className:"text-lg font-bold text-gray-900 mb-2 line-clamp-2",children:i.title}),e.jsxs("div",{className:"flex items-center gap-4 text-sm text-gray-600",children:[e.jsx("span",{children:i.author}),e.jsx("span",{children:i.readTime})]})]})})},i.id))})]})}),e.jsx(g,{})]}):e.jsx("div",{className:"min-h-screen bg-white flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:"Loading..."}),e.jsx("div",{className:"animate-spin rounded-full h-12 w-12 border-b-2 border-[#C30010] mx-auto"})]})})};export{v as default};
